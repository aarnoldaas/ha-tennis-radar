...
function TradeAnalysisPanel({ data }: { data: InvestmentData }) {
          ...
          <Table.Tbody>
            {filtered.map(a => (
              <Table.Tr key={a.symbol}>
                ...
                <Table.Td>
                  {a.lastBuyDate ? <><Text span size="sm">{a.lastBuyDate}</Text>{a.lastBuyPrice !== null && <Text span size="xs" c="dimmed"> @ {formatNum(a.lastBuyPrice)}</Text>}</> : '\u2014'}
                </Table.Td>
                <Table.Td>
                  {a.lastSellDate ? <><Text span size="sm">{a.lastSellDate}</Text>{a.lastSellPrice !== null && <Text span size="xs" c="dimmed"> @ {formatNum(a.lastSellPrice)}</Text>}</> : '\u2014'}
                </Table.Td>
