...
/**
 * Yahoo Finance fundamentals service, wrapping the unofficial `quoteSummary`
 * endpoint. It covers virtually every Yahoo-listed symbol, auth-free, and
 * returns trailing/forward P/E, EPS, growth, market cap, 52-week range,
