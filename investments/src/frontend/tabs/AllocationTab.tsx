...
import type { AllocationSlice, Portfolio } from '../../shared/types';
import { money, pct } from '../lib/format';

export function AllocationTab({ portfolio }: { portfolio: Portfolio }) {
  return (
    <Stack gap="md">
      <SimpleGrid cols={{ base: 1, md: 2 }} spacing="md">
        <DonutCard title="By asset class" slices={portfolio.allocation.assetClass} />
        <DonutCard title="By currency" slices={portfolio.allocation.currency} />
      </SimpleGrid>
    </Stack>
  );
}
