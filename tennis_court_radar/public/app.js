  ...
  function SlotTable({ slots }) {
    if (!slots || slots.length === 0) {
      return /* @__PURE__ */ u3("div", { class: "empty-state", children: [
        /* @__PURE__ */ u3("div", { class: "empty-state-icon", children: "\u{1F3BE}" }),
        /* @__PURE__ */ u3("p", { class: "empty-state-title", children: "No courts available" }),
        /* @__PURE__ */ u3("p", { class: "empty-state-sub", children: "No courts matching your preferences were found. We'll keep checking!" })
      ] });
    }
    const byDate = {};
    ...
    return /* @__PURE__ */ u3("div", { class: "slots-section", children: [
      /* @__PURE__ */ u3("div", { class: "slots-summary", children: [
        /* @__PURE__ */ u3("span", { class: "slots-count", children: totalCount }),
        /* @__PURE__ */ u3("span", { class: "slots-count-label", children: [
          "court",
          totalCount !== 1 ? "s" : "",
          " available"
        ] })
      ] }),
      Object.entries(byDate).sort().map(([date, dateSlots]) => /* @__PURE__ */ u3("div", { class: "date-group", children: [
        /* @__PURE__ */ u3("div", { class: "date-group-header", children: [
          /* @__PURE__ */ u3("span", { class: "date-group-title", children: formatDate(date) }),
          /* @__PURE__ */ u3("span", { class: "date-group-count", children: [
            dateSlots.length,
            " slot",
            dateSlots.length !== 1 ? "s" : ""
          ] })
        ] }),
        /* @__PURE__ */ u3("div", { class: "slot-grid", children: dateSlots.sort((a3, b) => a3.startTime.localeCompare(b.startTime)).map((s3, i3) => /* @__PURE__ */ u3("div", { class: "slot-card", children: [
          /* @__PURE__ */ u3("div", { class: "slot-card-time", children: [
            /* @__PURE__ */ u3("span", { class: "slot-time-range", children: [
              s3.startTime,
              " \u2013 ",
              s3.endTime
            ] }),
            /* @__PURE__ */ u3("span", { class: "slot-duration", children: [
              s3.durationMinutes,
              " min"
            ] })
          ] }),
          /* @__PURE__ */ u3("div", { class: "slot-card-details", children: [
            /* @__PURE__ */ u3("span", { class: "slot-court-name", children: s3.courtName }),
            /* @__PURE__ */ u3("span", { class: "slot-provider", children: s3.provider })
          ] })
        ] }, i3)) })
      ] }, date))
    ] });
